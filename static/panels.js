...
function _revertSettingsPreview(){
  ...
  if(_settingsFontOnOpen){
    _applyFontSize(_settingsFontOnOpen);
  }
  if(_settingsFontThemeOnOpen!==null){
    _applyFontTheme(_settingsFontThemeOnOpen);
  }
}
...
function _applyFontSize(size){
  document.documentElement.style.setProperty('--font-size', (parseInt(size)||14)+'px');
...
async function loadSettingsPanel(){
  try{
    ...
    // Font size preference — populate with localized options
    ...
    // Font theme preference — populate with localized options
